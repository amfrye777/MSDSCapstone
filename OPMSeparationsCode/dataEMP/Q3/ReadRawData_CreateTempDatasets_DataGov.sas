...
****  Program Creates 17 temporary SAS data sets for data analysis;                                     
****    - FACTDATA_MMMYYYY table and 16 Dimension Translations tables (DTtables);       
****
****  NOTE: 
****    - Change PATH1 Statement below to directory path Raw Data sets are in;	 
****    - Change FILENAME Statement for FACTDATA to correct FACTDATA month (e.g. FACTDATA_JUN2015.txt);
...
FILENAME FACTDATA "&PATH1.FACTDATA_JUN2015.txt";
